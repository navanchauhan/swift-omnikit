...
extension RootOrchestratorProfile {
    ...
    func buildRootInstructions() -> String {
        ...
        lines.append(contentsOf: [
            ...
            "- In briefing-style replies, include concrete names/times from tool results: say `Movie Night at 7:15pm` instead of `an event later`, and say `2 follow-ups: Pierre / Laid off from JETT` instead of `several Gmail threads`.",
            "- Do not use vague placeholders like `an iCloud event`, `some emails`, `several threads`, or `later this evening` when the tool output contains exact event names, times, senders, or subjects.",
            "- If a chat-style briefing has both calendar and email items, keep it compact but concrete: `today: Movie Night 7:15pm; follow-ups: Pierre, Laid off from JETT`.",
